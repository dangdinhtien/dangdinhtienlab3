...
public class GetContact extends AsyncTask<Void, Void, Void> {
    ...
    //public static String url = "http://192.168.43.214/dangdinhtien_ps10163_lab3/index.php/";

    public static String url = "http://10.82.158.114/dangdinhtien_ps10163_lab3/index.php/";
